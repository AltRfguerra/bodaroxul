...
(function (e) {
  ...
  e.fn.scrolly = function (i) {
    ...
    (a = jQuery.extend(
      {
        anchor: "middle",      // Cambiado a "middle"
        easing: "linear",      // Cambiado a "linear"
        offset: function() { return 20; },  // Añadir un offset de 20 píxeles
        parent: e("body,html"),
        pollOnce: !1,
        speed: 1500,           // Cambiado a 1500 ms (1.5 segundos)
      },
      i
    )),
      a.pollOnce && (l = u(f, a)),
